      ...
      <div className='container mx-auto px-8 lg:flex'>
        <div className='text-center lg:text-left lg:w-1/2'>
          ...
          <p className='text-xl lg:text-2xl mt-6 font-light'>
            Fast, affordable, and totally custom website creation and maintenance for your small
            business.
          </p>
    ...
    <section id='services' className='py-20 lg:pb-40 lg:pt-48'>
      <div className='container mx-auto text-center'>
        <h2 className='text-3xl lg:text-5xl font-semibold'>
          The perfect{' '}
          <span className='bg-black text-white rounded pb-4 pr-3 pl-3 border border-solid border-gray-200'>
            &lt;page/&gt;
          </span>{' '}
          for your:
        </h2>
